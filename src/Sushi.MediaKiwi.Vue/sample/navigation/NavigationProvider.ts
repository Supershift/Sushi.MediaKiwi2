...
builder
  ...
  .addNavigationItem("CustomerOverview", "Customers", "./views/Customers/Customers.vue", undefined, "$customer", "custom-css-layout")
  .endSection()
  .startSection("CRM", "CRM", "symbols:manage_accounts")
  .addNavigationItem("Countries", "Countries", "./views/Country/Countries.vue")
  .right()
  ...
  .addNavigationItem("CountriesEmptyCustomActions", "Countries (Custom Empty state)", "./views/Country/CountriesEmptyCustomActions.vue")
  .endSection()
