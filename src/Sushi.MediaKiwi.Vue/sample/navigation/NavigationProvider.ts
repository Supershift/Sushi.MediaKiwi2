...
builder
  ...
  .addNavigationItem("CountriesManual", "Countries manual", "./countries/views/CountriesManualSort.vue")
  .right()
  .addNavigationItem("CountryEdit", "Country", "./countries/views/CountryEdit.vue", "countryId")
  .left()
  .addNavigationItem("CountriesAuto", "Countries auto", "./countries/views/CountriesAutoSort.vue")
  .addNavigationItem("CountriesServer", "Countries server", "./countries/views/CountriesServer.vue")
