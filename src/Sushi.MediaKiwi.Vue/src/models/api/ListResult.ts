...
export default class ListResult<T> implements IListResult<T> {
  ...
  private constructorWithTotalCount(result: Array<T>, totalCount: number | null | undefined) {
    this.result = result;
    this.totalCount = totalCount;
  }
  private constructorWithCounts(result: Array<T>, totalCount: number | null | undefined, pageCount: number | null | undefined) {
    this.result = result;
    this.totalCount = totalCount;
