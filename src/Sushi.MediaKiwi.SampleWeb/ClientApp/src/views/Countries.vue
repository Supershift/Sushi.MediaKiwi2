<script setup lang="ts">
  ...
  import { ListResult, MkTable, TableMap, useKeyboardShortcuts, MkTextbox } from "@supershift/mediakiwi-vue";
  ...
  async function onUpdateDataItem(dataItem: Country) {
    await connector.SaveAsync(dataItem);
  }
</script>
<template>
  <mk-table
